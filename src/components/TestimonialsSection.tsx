      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="mt-4 text-sm sm:text-base text-neutral-gray font-light leading-relaxed">
            Real stories from our international patients: honest feedback, photo-backed aesthetic transformations, and personal accounts of their recovery and comfort.
          </p>
        </div>
            ...
            return (
              <div
                ...
                className={`bg-white rounded-2xl p-8 border transition-all duration-300 flex flex-col justify-between cursor-pointer ${
                  isFocused
                    ? 'border-primary-blue shadow-xl scale-[1.02]'
              ...
              >
                <div>
                  ...
                  {/* Testimonial Text */}
                  <p className="text-sm sm:text-base text-neutral-gray font-light leading-relaxed italic">
                    "{testimonial.text}"
                  </p>
                </div>
                ...
                <div className="flex items-center space-x-4 mt-8 pt-6 border-t border-gray-100">
                  ...
                  />
                  <div>
                    <h4 className="text-sm sm:text-base font-bold text-neutral-charcoal">
                      {testimonial.name}
                    </h4>
          ...
          {TESTIMONIALS.map((_, idx) => (
            <button
              ...
              className={`w-3 h-3 rounded-full transition-all duration-200 ${
                activeDot === idx ? 'bg-accent-magenta scale-125' : 'bg-gray-200 hover:bg-gray-300'
              }`}
